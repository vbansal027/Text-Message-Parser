...
from msgParser.train.train_controller import train
from msgParser.classify.classify_controller import classify
...
def create_app(test_config=None):
    ...
    #     SECRET_KEY = 'dev'
    # )
    app.config.from_object('msgParser.settings')
